...
const Footer: React.FC = () => {
  return (
    <footer className="bg-catering dark:bg-catering text-white p-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="flex md:col-span-4 col-span-12 flex-col gap-1">
              <div className="flex gap-3">
                <a
                  target="_blank"
                  href="https://www.facebook.com/profile.php?id=61565159289936"
                >
                ...
                <a
                  target="_blank"
                  href="https://www.instagram.com/prime.catering/"
                >
                  <div className="p-2 rounded-lg flex items-center justify-between hover:bg-stone-900 dark:hover:bg-stone-800">
              ...
              <div className="text-sm">
                <a href="tel:88885073">Утас: +976 88885073</a>
                <a href="tel:86867996"> +976 86867996</a>
                <a href="tel:86197584"> + 976 86197584</a>
              </div>
              <div className="text-sm">
